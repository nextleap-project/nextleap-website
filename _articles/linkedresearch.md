...
![The Annotation Protocol]({{ "/articles/img/1annotationprotocol.png" | absolute_url }})

##### Fig. 2 Example of annotated page. #####
![The Annotation Protocol]({{ "/articles/img/2annotatedpage.png" | absolute_url }})
...
##### Fig. 3 Comment box. #####
![The Annotation Protocol]({{ "/articles/img/3commentbox.png" | absolute_url }})

##### Fig. 4 NetRights Glossary #####
![The Annotation Protocol]({{ "/articles/img/4dashboard.png" | absolute_url }})
...
![The Annotation Protocol]({{ "/articles/img/5netrightsglossary.png" | absolute_url }})
